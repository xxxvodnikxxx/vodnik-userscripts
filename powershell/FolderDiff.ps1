...
$files1 = Get-ChildItem -Path $Folder1 -File -Recurse | ForEach-Object { $_.FullName.Substring($Folder1.Length+1) }
$files2 = Get-ChildItem -Path $Folder2 -File -Recurse | ForEach-Object { $_.FullName.Substring($Folder2.Length+1) }
